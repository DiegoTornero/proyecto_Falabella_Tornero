...
class Credito(Base):
    ...
    id = Column(String, primary_key=True, default=gen_uuid)
    usuario_id = Column(String, ForeignKey("usuarios.id"), nullable=True)   # nullable: créditos empresariales no tienen usuario
    empresa_id = Column(String, ForeignKey("empresas.id"), nullable=True)   # nullable: créditos personales no tienen empresa
